...
public class IA_droite extends IA{
    ...
    public Type_Action action() {
        ...
        else if (typeCaseDroite == Type_Case.MurDur && mapEntite.getJoueur().getPelle()==false ){
            System.out.println("need pelle améliorée");
        }
        else if ((typeCaseDroite == Type_Case.Sol && caseDroite.getEntite()!=null)||typeCaseDroite == Type_Case.Mur||(typeCaseDroite == Type_Case.MurDur && mapEntite.getJoueur().getPelle())){
